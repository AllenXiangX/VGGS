...
class OptimizationParams(ParamGroup):
    def __init__(self, parser):
        ...
        self.max_iterations = 7_000
        self.position_lr_init = 0.00016
        self.position_lr_final = 0.0000016
        self.position_lr_delay_mult = 0.01
        self.position_lr_max_steps = 15_000 # 30_000   # 15_000 for vggt init ranking 
        ...
        self.single_view_weight_from_iter = 1000-1 # 7000 
        ...
        self.rank_from = 2000
        self.multi_view_weight_from_iter = 1000 # 10000 # 10000
