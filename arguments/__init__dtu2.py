...
class ModelParams(ParamGroup): 
    def __init__(self, parser, sentinel=False):
        ...
        self.multi_view_max_angle = 45 # 180 # 
        self.multi_view_min_dis = 0.01
        self.multi_view_max_dis = 3.0 # 5.0 # 1.5  # 5. # 
...
class OptimizationParams(ParamGroup):
    def __init__(self, parser):
        ...
        self.position_lr_max_steps = 3_000 # 15_000 # 30_000   # 15_000 for vggt init ranking 
        ...
        self.depth_conf_thrsh = 2.0
        self.depth_conf_thrsh_2 = 2.0
