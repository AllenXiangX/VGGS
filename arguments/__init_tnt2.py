...
class ModelParams(ParamGroup): 
    def __init__(self, parser, sentinel=False):
        ...
        self.multi_view_max_angle = 60 # 90 # 60 # 60 #  60 for tnt 10 views    90 for 5 views
        self.multi_view_min_dis = 0.01
        self.multi_view_max_dis = 4.0  # 8.0 # 4.0 # 4.0 # 4.0 for tnt 10 views  8.0 for 5 views
...
class OptimizationParams(ParamGroup):
    def __init__(self, parser):
        self.iterations = 3_000 # 15_000 # 30_000
        self.position_lr_init = 0.00016
        self.position_lr_final = 0.0000016
        self.position_lr_delay_mult = 0.01
        self.position_lr_max_steps = 3_000 # 30_000   # 15_000 for vggt init ranking 
        ...
        self.single_view_weight_from_iter = 500-1 # 7000 
        ...
        self.rank_from = 2000
        self.multi_view_weight_from_iter = 500 # 10000 # 10000
        self.align_from_iter = 1000
        self.peudo_gt_sep_iter = 500
        self.depth_conf_thrsh = 1.5
        self.depth_conf_thrsh_2 = 0.0
